...
class TextGenerationPipeline {
    ...
    static async getInstance(progress_callback = null) {
        ...
        this.model_id = 'onnx-community/Qwen3.5-2B-ONNX-OPT';
...
async function generate(messages) {
    ...
    // Keep only newly generated tokens (remove original prompt)
    const generatedTokens = outputs.slice(null, [promptLength, null]);

    const outputText = tokenizer.batch_decode(generatedTokens, { skip_special_tokens: true });
